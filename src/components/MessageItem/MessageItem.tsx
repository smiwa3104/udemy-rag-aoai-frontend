...
const MessageItem = ({ message, isMan }: { message: string, isMan: boolean }) => {
    ...
    return isMan ? (
        <div className='flex mb-4 justify-end'>
            ...
            <div className='flex items-center justify-center w-10 overflow-hidden bg-gray-100 rounded-full ml-4'>
        ...
        <div className='flex mb-4'>
            <div className='flex items-center justify-center w-10 overflow-hidden bg-gray-100 rounded-full mr-4'>
                <div className='font-medium text-gray-600'>
                    <FaRobot />
                </div>
            </div>
